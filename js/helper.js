...
/*
These are HTML strings. you'll be using JavaScript functions
replace the %data% placeholder text you see in them.
*/
var HTMLheaderName = '<h1 id="name">%data%</h1>';
var HTMLheaderRole = '<span id="role">%data%</span><br><hr/>';
...
var HTMLbioPic = '<img class="img-responsive biopic" src="%data%" >';
...
var HTMLProjectSpace ='<div class="space"></div>';
